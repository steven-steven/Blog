...
%o`, message, error3, detail);
  ...
  // assets/javascripts/controllers/dark_toggle_controller.js
  var dark_toggle_controller_default = class extends Controller {
  ...
  var subscription_controller_default = class extends Controller {
    static targets = ["successTemplate", "failTemplate"];
    static values = {
      token: String
    };
    connect() {
    ...
    async showResponse() {
      const response = await this.fetchConfirmSubscription();
      let template = response ? this.successTemplateTarget : this.failTemplateTarget;
      let clon = template.content.cloneNode(true);
      this.element.appendChild(clon);
    }
    async fetchConfirmSubscription() {
      if (this.tokenValue == "")
        return false;
      const app_script_url = "app_script_url";
      const url = `${app_script_url}?token=${this.tokenValue}&p=confirm-subscribe`;
      try {
...
//# sourceMappingURL=/assets/build/application.js-5b61734be85d04e8b1415f355a88bf6cbfcb04de9b960b1ce9947f5762e79ea1.map
//!
;
